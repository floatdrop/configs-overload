...
This document describes some points about contribution process for configs-overload package.

The maintainer of the project is Vsevolod Strukchinsky (floatdrop@gmail.com).
